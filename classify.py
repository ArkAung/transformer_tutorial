...
def go(arg):
    ...
    if arg.final:
        ...
        train_iter, test_iter = data.BucketIterator.splits((train, test), batch_size=arg.batch_size, device=utils.d())
    else:
    ...
    # create the model
    model = Transformer(embed_dim=arg.embedding_size, heads=arg.num_heads, depth=arg.depth,
